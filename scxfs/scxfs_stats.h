 ...
 * All Rights Reserved.
 */
#ifndef __SCXFS_STATS_H__
#define __SCXFS_STATS_H__
 ...
 * store the base index in the btree cursor via SCXFS_STATS_CALC_INDEX() and
...
extern int scxfs_init_procfs(void);
extern void scxfs_cleanup_procfs(void);


#else	/* !CONFIG_PROC_FS */

static inline int scxfs_init_procfs(void)
{
	return 0;
}

static inline void scxfs_cleanup_procfs(void)
{
}

#endif	/* !CONFIG_PROC_FS */

#endif /* __SCXFS_STATS_H__ */
