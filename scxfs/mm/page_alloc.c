...
static inline enum zone_type scxfs_gfp_zone(gfp_t flags)
{
	enum zone_type z;
...
extern unsigned long scxfs_try_to_free_pages(struct zonelist *zonelist, int order,
					...
					const struct alloc_context *ac)
{
	...
	progress = scxfs_try_to_free_pages(ac->zonelist, order, gfp_mask,
								ac->nodemask);
...
static inline struct page *
__scxfs_alloc_pages_slowpath(gfp_t gfp_mask, unsigned int order,
							...
							nodemask_t *nodemask)
{
	...
	page = __scxfs_alloc_pages_slowpath(alloc_mask, order, &ac);
