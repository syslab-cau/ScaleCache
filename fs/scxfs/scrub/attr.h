 ...
 */
#ifndef __SCXFS_SCRUB_ATTR_H__
#define __SCXFS_SCRUB_ATTR_H__
...
int xchk_setup_xattr_buf(struct scxfs_scrub *sc, size_t value_size,
		scxfs_km_flags_t flags);

#endif	/* __SCXFS_SCRUB_ATTR_H__ */
