 ...
 */
void scext4_truncate_inode_pages_range(struct address_space *mapping,
 ...
 */
void scext4_truncate_inode_pages_final(struct address_space *mapping)
{
	 ...
	 * entries.
	 */
	scext4_truncate_inode_pages(mapping, 0);
}
 ...
 */
int scext4_invalidate_inode_pages2_range(struct address_space *mapping,
				  pgoff_t start, pgoff_t end)
{
	pgoff_t indices[PAGEVEC_SIZE];
	struct pagevec pvec;
 ...
 * Return: -EBUSY if any pages could not be invalidated.
 */
int scext4_invalidate_inode_pages2(struct address_space *mapping)
{
	return scext4_invalidate_inode_pages2_range(mapping, 0, -1);
}
 ...
 */
void scext4_truncate_pagecache(struct inode *inode, loff_t newsize)
{
	...
	scext4_truncate_inode_pages(mapping, newsize);
	unmap_mapping_range(mapping, holebegin, 0, 1);
}
//EXPORT_SYMBOL(truncate_pagecache);

void scext4_pagecache_isize_extended(struct inode *inode, loff_t from, loff_t to);
 ...
 */
void scext4_truncate_setsize(struct inode *inode, loff_t newsize)
{
	loff_t oldsize = inode->i_size;

	i_size_write(inode, newsize);
	if (newsize > oldsize)
		scext4_pagecache_isize_extended(inode, oldsize, newsize);
	scext4_truncate_pagecache(inode, newsize);
}
 ...
 * had its underlying blocks deallocated.
 */
void scext4_truncate_pagecache_range(struct inode *inode, loff_t lstart, loff_t lend)
{
	struct address_space *mapping = inode->i_mapping;
	...
	scext4_truncate_inode_pages_range(mapping, lstart, lend);
}
