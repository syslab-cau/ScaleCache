...
EXPORT_SYMBOL(dirty_background_ratio);
...
EXPORT_SYMBOL(vm_highmem_is_dirtyable);

/*
 * The generator of dirty data starts writeback at this percentage
 */
int vm_dirty_ratio = 20;
EXPORT_SYMBOL(vm_dirty_ratio);
...
EXPORT_PER_CPU_SYMBOL(bdp_ratelimits);
...
EXPORT_PER_CPU_SYMBOL(dirty_throttle_leaks);
			     ...
			     pgoff_t start, pgoff_t end)
{
	...
	if (!cc_xas_is_ccxarray(&xas))
		return tag_pages_for_writeback(mapping, start, end);
...
EXPORT_SYMBOL(__set_page_dirty_no_writeback);	// seokjoo
