...
EXPORT_SYMBOL(cgroup_memory_nosocket);
...
EXPORT_SYMBOL(memcg_cgwb_frn_waitq);
#endif
...
EXPORT_SYMBOL(memcg_kmem_cache_wq);
#endif

//static int memcg_shrinker_map_size;
//static DEFINE_MUTEX(memcg_shrinker_map_mutex);
int memcg_shrinker_map_size;
DEFINE_MUTEX(memcg_shrinker_map_mutex);
EXPORT_SYMBOL(memcg_shrinker_map_size);
EXPORT_SYMBOL(memcg_shrinker_map_mutex);
...
EXPORT_SYMBOL(__mod_lruvec_slab_state);
...
EXPORT_SYMBOL(mem_cgroup_track_foreign_dirty_slowpath);
